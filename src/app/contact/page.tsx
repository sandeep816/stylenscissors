          ...
          {siteSettings?.googleMapsEmbed && (
            <div className="mt-12">
              ...
              <div className="aspect-video w-full rounded-lg overflow-hidden">
                {/* 
                    Handle cases where the user pastes the full <iframe> tag instead of just the URL.
                    We extract the src attribute if it exists, otherwise use the string as is.
                 */}
                <iframe
                  src={
                    siteSettings.googleMapsEmbed.includes('<iframe')
                      ? (siteSettings.googleMapsEmbed.match(/src="([^"]+)"/)?.[1] || "")
                      : siteSettings.googleMapsEmbed
                  }
                  width="100%"
                  height="100%"
